...
class PackFactory
  ...
  private def build_pack_with_random_foil(set_code, foil_sheet, replacement_sheet, distribution, common_if_no_basic: false)
    ...
    WeightedPack.new({ normal_pack => 3, foil_pack => 1 })
  end
  ...
  def for(set_code)
    ...
    when 'm10', 'm11', 'm12', 'm13', 'm14', 'm15',
      ...
      'akh', 'hou',
      'm19'
      build_pack_with_random_foil(set_code, :foil, :common, { basic: 1, common: 10, uncommon: 3, rare_or_mythic: 1 },
                                  common_if_no_basic: true)
    when 'mma', 'mm2', 'mm3', 'ema', 'ima', 'a25'
      build_pack(set_code, { common: 10, uncommon: 3, rare_or_mythic: 1, foil: 1 })
    when 'dgm'
      build_pack_with_random_foil(set_code, :foil, :dgm_common,
                                  { dgm_common: 10, uncommon: 3, dgm_rare_mythic: 1, dgm_land: 1 })
    when 'frf'
      build_pack_with_random_foil(set_code, :foil, :frf_common,
                                  { frf_common: 10, uncommon: 3, rare_or_mythic: 1, frf_land: 1 })
    when 'uh'
      build_pack_with_random_foil(set_code, :unhinged_foil, :common,
                                  { common: 10, uncommon: 3, rare_or_mythic: 1, basic: 1 })
    when 'jou'
      WeightedPack.new(
    ...
    when 'isd'
      build_pack_with_random_foil(set_code, :foil, :sfc_common,
                                  { isd_dfc: 1, basic: 1, sfc_common: 9, sfc_uncommon: 3, sfc_rare_or_mythic: 1 })
    when 'dka'
      build_pack_with_random_foil(set_code, :foil, :sfc_common,
                                  { dka_dfc: 1, sfc_common: 10, sfc_uncommon: 3, sfc_rare_or_mythic: 1 })
    when 'ts'
    ...
    when 'pc'
      ...
      build_pack_with_random_foil(set_code, :foil, :pc_common,
                                  { pc_common: 8, pc_uncommon: 2, pc_rare: 1, pc_cs_common: 3, pc_cs_uncommon_rare: 1 })
    when 'vma'
    ...
    when 'soi'
      ...
      WeightedPack.new(
        build_pack_with_random_foil(set_code, :foil, :sfc_common,
                                    { basic: 1, sfc_common: 9, sfc_uncommon: 3, sfc_rare_or_mythic: 1, soi_dfc_common_uncommon: 1 }) => 7,
        build_pack_with_random_foil(set_code, :foil, :sfc_common,
                                    { basic: 1, sfc_common: 8, sfc_uncommon: 3, sfc_rare_or_mythic: 1, soi_dfc_common_uncommon: 1, soi_dfc_rare_mythic: 1 }) => 1
      )
    when 'emn'
      # Same assumptions as SOI, except no basics in the set
      WeightedPack.new(
        build_pack_with_random_foil(set_code, :foil, :sfc_common,
                                    { sfc_common: 10, sfc_uncommon: 3, sfc_rare_or_mythic: 1, emn_dfc_common_uncommon: 1 }) => 7,
        build_pack_with_random_foil(set_code, :foil, :sfc_common,
                                    { sfc_common: 9, sfc_uncommon: 3, sfc_rare_or_mythic: 1, emn_dfc_common_uncommon: 1, emn_dfc_rare_mythic: 1 }) => 1
      )
    when 'cns'
      WeightedPack.new(
        build_pack_with_random_foil(set_code, :cns_nondraft_foil, :cns_nondraft_common,
                                    { cns_draft: 1, cns_nondraft_common: 10, cns_nondraft_uncommon: 3, cns_nondraft_rare_or_mythic: 1 }) => 39,
        build_pack_with_random_foil(set_code, :cns_nondraft_foil, :cns_nondraft_common,
                                    { cns_draft_foil: 1, cns_nondraft_common: 10, cns_nondraft_uncommon: 3, cns_nondraft_rare_or_mythic: 1 }) => 1
      )
    when 'dom'
      ...
      WeightedPack.new(
        build_pack_with_random_foil(set_code, :foil, :common,
                                    { basic: 1, common: 10, dom_nonlegendary_uncommon: 3, dom_legendary_rare_mythic: 1 }) => 36 * (144 - 23),
        build_pack_with_random_foil(set_code, :foil, :common,
                                    { basic: 1, common: 10, dom_nonlegendary_uncommon: 2, dom_legendary_uncommon: 1, dom_legendary_rare_mythic: 1 }) => 36 * 23,
        build_pack_with_random_foil(set_code, :foil, :common,
                                    { basic: 1, common: 10, dom_nonlegendary_uncommon: 2, dom_legendary_uncommon: 1, dom_nonlegendary_rare_mythic: 1 }) => (121 - 36) * 144
      )
