...
class QueryTokenizer
  def tokenize(str)
    ...
    until s.eos?
      ...
      elsif s.scan(/(is|not)\s*[:=]\s*(vanilla|spell|permanent|multipart|promo|primary|secondary|front|back|commander|reprint|canon|tale|desertshock|shockfetch|mirrorland|bounceland|monofetch|plagueland|tormentland|cycleland|handland|investigateland|drawdual|checkland|scryland|tricheck|unique|draft|historic|staple|scuttleback|brawler|storied|modal)\b/i)
