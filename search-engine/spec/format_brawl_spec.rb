...
describe 'Formats - Brawl' do
  ...
  it do
    assert_block_composition 'brawl', Date.parse('2018-05-11'), %w[kld aer akh w17 hou xln rix dom],
                             "Smuggler's Copter" => 'banned',
                             'Baral, Chief of Compliance' => 'banned',
                             'Sorcerous Spyglass' => 'banned'
    assert_block_composition 'brawl', 'dom', %w[kld aer akh w17 hou xln rix dom],
                             "Smuggler's Copter" => 'banned',
