...
describe 'Formats - Modern' do
  ...
  it 'modern' do
    assert_block_composition 'modern', 'rix', %w[8e mi ds 5dn chk bok sok 9e rav gp di cs ts tsts pc fut 10e lw mt shm eve ala cfx arb m10 zen wwk roe m11 som mbs nph m12 isd dka avr m13 rtr gtc dgm m14 ths bng jou m15 ktk frf dtk ori bfz ogw soi emn kld aer akh w17 hou xln rix],
                             'Ancient Den' => 'banned',
                             'Birthing Pod' => 'banned',
