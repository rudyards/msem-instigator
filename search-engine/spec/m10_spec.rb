...
describe 'Magic 2010' do
  ...
  it 'rarity' do
    ...
    assert_search_results 'r:rare t:land', 'Dragonskull Summit', 'Drowned Catacomb', 'Gargoyle Castle',
                          'Glacial Fortress', 'Rootbound Crag', 'Sunpetal Grove'
  ...
  it 'is_spell' do
    assert_search_results 'e:m10 r:rare ci:c is:spell', 'Coat of Arms', 'Howling Mine', 'Magebane Armor',
                          'Mirror of Fate', 'Pithing Needle'
    assert_search_results 'e:m10 r:rare ci:c', 'Coat of Arms', 'Howling Mine', 'Magebane Armor', 'Mirror of Fate',
                          'Pithing Needle', 'Gargoyle Castle'
  end
