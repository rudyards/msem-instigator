...
describe 'Card nicknames' do
  ...
  it 'is:shockland' do
    assert_search_results 'is:shockland',
                          ...
                          'Temple Garden',
                          'Watery Grave'
    assert_search_equal 'is:shockland',
                        %(o:"As ~ enters the battlefield, you may pay 2 life. If you don't, ~ enters the battlefield tapped.")
  end
  ...
  it 'is:fetchland' do
    ...
    assert_search_results 'is:fetchland',
                          *cards_matching do |c|
                            c.text =~ /\{T\}, Pay 1 life, Sacrifice #{c.name}: Search your library for an? \S+ or \S+ card, put it onto the battlefield, then shuffle your library./
                          end
  ...
  it 'is:fastland' do
    ...
    assert_search_results 'is:fastland',
                          *cards_matching do |c|
                            c.text =~ /#{c.name} enters the battlefield tapped unless you control two or fewer other lands.\n\{T\}: Add \{.\} or \{.\}./
                          end
  end
  ...
  it 'is:checkland' do
    ...
    assert_search_results 'is:checkland',
                          *cards_matching do |c|
                            c.text =~ /#{c.name} enters the battlefield tapped unless you control an? \S+ or an? \S+.\n\{T\}: Add \{.\} or \{.\}./
                          end
  end
