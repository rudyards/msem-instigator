...
describe 'Full Database Test' do
  ...
  it 'stats' do
    db.number_of_cards.should eq(18_748)
    db.number_of_printings.should eq(37_176)
  end
  ...
  it 'edition special characters' do
    ...
    assert_search_equal 'e:us', %(e:"Urza’s Saga")
    assert_search_equal 'e:us or e:ul or e:ud', %(e:"urza's")
    assert_search_equal 'e:us or e:ul or e:ud', %(e:"urza’s")
    assert_search_equal 'e:us or e:ul or e:ud', %(e:"urza")
  end
  ...
  it 'print date' do
    assert_search_results %(print="29 september 2012"),
                          'Archon of the Triumvirate',
                          'Carnival Hellsteed',
                          'Corpsejack Menace',
                          'Grove of the Guardian',
                          'Hypersonic Dragon'
    assert_search_equal %(print="29 september 2012"), %(print=2012-09-29)
  end
  ...
  it 'firstprint' do
    assert_search_results 't:planeswalker firstprint=m12', 'Chandra, the Firebrand', 'Garruk, Primal Hunter',
                          'Jace, Memory Adept'
  end
  ...
  it 'mana variables' do
    ...
    assert_search_equal 'mana={m}{w/b}',
                        'mana={w}{w/b} OR mana={u}{w/b} OR mana={b}{w/b} OR mana={r}{w/b} OR mana={g}{w/b}'
  end
  ...
  it 'comma separated set list' do
    assert_search_equal 'e:cmd or e:cm1 or e:c13 or e:c14 or e:c15 or e:c16 or e:c17 or e:c18 or e:cma or e:cm2',
                        'e:cmd,cm1,c13,c14,c15,c16,c17,c18,cma,cm2'
    assert_search_equal 'st:cmd -alt:-st:cmd',
                        'e:cmd,cm1,c13,c14,c15,c16,c17,c18,cma,cm2 -alt:-e:cmd,cm1,c13,c14,c15,c16,c17,c18,cma,cm2'
  end
  ...
  it 'is:permanent' do
    assert_search_equal 'is:permanent',
                        'not (t:instant or t:sorcery or t:plane or t:scheme or t:phenomenon or t:conspiracy or t:vanguard)'
  end
  ...
  it 'promo and special' do
    ...
    assert_search_results %(r:special -is:promo -st:masterpiece -t:vanguard -e:anthologies -e:tsts -e:"clash pack" -e:vma -e:mgbc),
  ...
  it "Non-alphanumeric characters in set names are ignored and 's is normalized" do
    ...
    assert_search_equal %(e:"Ugin's Fate promos"), %(e:"Ugin Fate promos")
    assert_search_equal %(e:"Ugin's Fate promos"), %(e:"Ugins Fate promos")
    assert_search_equal %(e:"Duel Decks Anthology, Divine vs. Demonic"), %(e:"Duel Decks Anthology Divine vs Demonic")
    assert_search_equal %(e:"Magic: The Gathering—Conspiracy"), %(e:"Magic The Gathering Conspiracy")
  end
