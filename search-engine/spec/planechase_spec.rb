...
describe 'Planechase' do
  ...
  it 'plane' do
    assert_search_results 't:plane t:Dominaria', 'Krosa', 'Llanowar', 'Academy at Tolaria West', 'Isle of Vesuva',
                          'Otaria', 'Shiv', 'Talon Gates'
    assert_search_results 't:Dominaria', 'Krosa', 'Llanowar', 'Academy at Tolaria West', 'Isle of Vesuva', 'Otaria',
                          'Shiv', 'Talon Gates'
