...
describe 'Spelling' do
  ...
  it 'spelling' do
    ...
    spelling_suggestions('SHANDRAA').should eq(%w[chandra shandlar])
  ...
  it 'spelling_short_words' do
    ...
    spelling_suggestions('mux').should eq(%w[lux mox mu mul])
  ...
  it 'every card with hyphen can be searched as one or two words' do
    ...
    cards_with_hyphens.each_with_index do |name, _i|
      # Ignore 3+ part names
      next if name =~ /-\S+-/
