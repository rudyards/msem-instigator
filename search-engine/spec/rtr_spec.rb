...
describe 'Return to Ravnica block' do
  ...
  it 'extort reminder text does not affect ci:' do
    assert_search_results 'o:extort ci:w', 'Basilica Guards', 'Blind Obedience', 'Knight of Obligation',
                          'Syndic of Tithes'
    assert_search_results 'o:extort ci:b', 'Basilica Screecher', 'Crypt Ghast', 'Pontiff of Blight',
                          'Syndicate Enforcer', 'Thrull Parasite'
    assert_search_results 'o:extort ci:bw -ci:w -ci:b', "Kingpin's Pet", 'Tithe Drinker', 'Treasury Thrull',
                          'Vizkopa Confessor'
  end
