...
describe 'Formats' do
  ...
  it 'formats' do
    ...
    assert_search_equal_cards 'f:standard',
                              %(e:kld,aer,akh,w17,hou,xln,rix,dom,m19 -"Smuggler's Copter" -"Felidar Guardian" -"Aetherworks Marvel" -"Attune with Aether" -"Rogue Refiner" -"Rampaging Ferocidon" -"Ramunap Ruins")
  ...
  it 'ban_events' do
    ...
    FormatModern.new.ban_events.should eq([
                                            [Date.parse('2018-02-19'),
                                             ...
                                             [
                                               { name: 'Jace, the Mind Sculptor', old: 'banned',
                                                 new: 'legal' },
