...
describe 'Ability Word Regexp' do
  ...
  it 'ability words and similar' do
    ...
    (dash_prefixes - ability_words).should match_array(['An opponent chooses one', 'Choose one', 'Choose one or both',
                                                        'Choose one or more', 'Choose two', 'Forecast', 'DCI ruling', 'I', 'II', 'III'])
